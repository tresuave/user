...
class Ethereal extends Component {
    ...
    render() {
        ...
        return (
            <div>
                  <iframe width="560" height="315" src="https://www.youtube.com/embed/3pGwlKjpdfc?start=8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> 
